...
const MetaCampaignArea = () => {
  return (
    <>
      ...
      />
      <link
        href="assets/assetsdigitalmarketing/vendor/boxicons/css/boxicons.min.css"
        rel="stylesheet"
      />
      <link
        href="assets/assetsdigitalmarketing/vendor/venobox/venobox.css"
        rel="stylesheet"
      />
      {/* <link href="assets/assetsdigitalmarketing/vendor/aos/aos.css" rel="stylesheet" /> */}
      {/* Template Main CSS File */}
      <link
        href="assets/assetsdigitalmarketing/css/style.css"
        rel="stylesheet"
      />
      {/* =======================================================
            ...
            <div className="row">
              ...
              <div className="col-xl-6 pl-0 pl-lg-5 pr-lg-1 d-flex align-items-stretch">
                <div className="content d-flex flex-column justify-content-center">
                  ...
                  <p data-aos="fade-in">
                    Nyas Consultants drives success with tailored digital
                    marketing strategies, including SEO, Google Ads, Meta
                    campaigns, and backlink generation to boost online
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      <p>
                        Meta campaigns engage audiences, drive results, and
                        optimize targeting on Facebook, Instagram.
                      </p>
                    </div>
                    <div
                      className="col-md-6 icon-box"
          ...
          <div className="container">
            <div className="section-title">
              ...
              <p data-aos="fade-in">
                ...
                including SEO, Google Ads, Meta campaigns, and backlink
                strategies to elevate online visibility and drive growth. Our
                data-driven approach ensures optimized performance, high-quality
                leads, and valuable insights for impactful marketing results.
              </p>
            </div>
            <div
            ...
            >
              ...
              <div className="col-lg-7">
                <p>
                  ...
                  services, including SEO (Search Engine Optimization), Google
                  Ads, Meta (Facebook and Instagram) campaigns, and backlink
                  generation to increase your brand's online visibility and
            ...
            >
              ...
              <div className="col-lg-7">
                <p>
                  Our SEO strategies focus on improving your website’s search
                  engine ranking to attract organic traffic. By targeting
                  relevant keywords and optimizing site content, we help boost
                  your online presence and connect you with potential customers.
                </p>
              </div>
            </div>
            {/* End F.A.Q Item*/}
            ...
            >
              <div className="col-lg-5 d-flex align-items-center">
                ...
                <h4>
                  What is the benefit of using Google Ads in my marketing
                  strategy?
                </h4>
              </div>
              <div className="col-lg-7">
                <p>
                  ...
                  generating high-quality leads and increasing conversion rates.
                  Our team crafts tailored Google Ads campaigns to ensure you
            ...
            >
              ...
              <div className="col-lg-7">
                <p>
                  Meta campaigns are designed to engage audiences on Facebook
                  and Instagram, two of the largest social media platforms. We
                  create targeted, visually compelling ads that drive engagement
                  and results while optimizing to reach your specific audience.
                </p>
              </div>
            </div>
            {/* End F.A.Q Item*/}
            ...
            >
              ...
              <div className="col-lg-7">
                <p>
                  We offer comprehensive analytics and reporting to track
                  campaign performance. Our reports provide detailed insights
                  into key metrics, helping us and our clients make data-driven
                  adjustments to enhance future campaigns and maximize ROI.
                </p>
              </div>
            </div>
            {/* End F.A.Q Item*/}
